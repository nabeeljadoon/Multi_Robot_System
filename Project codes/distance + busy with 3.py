        ...
        while 46 in image:#stop khepera at goal
            if (66 in image2 and 0 in image3 ):
                ...
                if (d1>d2):
                    ...
                    j()
            if (0 in image2 and 66 in image3):
                ...
                if (d1>d1):
                    ...
                    m()
            if (0 in image2 and 0 in image3):
                if (d1>d2):
...
##            if ((xw>xu and yw>yu)  and (-76 in image2)):
##                l()
##                
##               
##            elif((66 in image3) and(xu>xv and yu>yv)):
##                m()
##                
##            elif ((xv>xu and yv>yu) and (66 in image3)):
##                l()
##                
##               
####            elif((xw<xu and yw<yu) and (-76 in image2)):
####                j()
####                
####            elif((66 in image4) and(xw<xv and yw<yv)):
####                j()
####                 
##            elif((xw>xv and yw>yv) and(66 in image4)):
##                m()    
##
##                
