     ...
     #####################################################################
       ...
       #################################################################################################################################
        ...
        if (46 in image3):#camera
            if (0 in image2 and 0 in image and 0 in image4):
                ...
                if (d2>d3 and d3>d1 ):
                    ...
                    l()
##########################################################################################
            if (46 in image2 and 0 in image and 0 in image4):
                m()
            if (0 in image2 and 46 in image and 0 in image4):
                j()                
            if (0 in image2 and 0 in image and 46 in image4):
                l()
###########################################################################################3
            if (46 in image2 and 46 in image and 0 in image4):
                if(d1>d2):
                    m()
                if(d2>d1):
                    j()

            if (0 in image2 and 46 in image and 46 in image4):
                if(d1>d3):
                    l()
                if(d3>d1):
                    j()                

            if (46 in image2 and 0 in image and 46 in image4):
                if(d2>d3):
                    l()
                if(d3>d2):
                    m()
###############################################################################
            if(d1>d2):
                if (66 in image2 and 46 in image and 0 in image4):
                    j()
            if(d1>d2):
                if (46 in image2 and 66 in image and 0 in image4):
                    m()
            if(d2>d1):
                if (66 in image2 and 46 in image and 0 in image4):
                    j()
            if(d2>d1):
                if (46 in image2 and 66 in image and 0 in image4):
                    m()                    
            if(d1>d3):
                if (0 in image2 and 46 in image and 66 in image4):
                    j()
            if(d1>d3):
                if (0 in image2 and 66 in image and 46 in image4):
                    l()
            if(d3>d1):
                if (0 in image2 and 46 in image and 66 in image4):
                    j()
            if(d3>d1):
                if (0 in image2 and 66 in image and 46 in image4):
                    l()
            if(d2>d3):
                if (46 in image2 and 0 in image and 66 in image4):
                    m()
            if(d2>d3):
                if (66 in image2 and 0 in image and 46 in image4):
                    l()
            if(d3>d2):
                if (46 in image2 and 0 in image and 66 in image4):
                    m()
            if(d3>d2):
                if (66 in image2 and 0 in image and 46 in image4):
                    l()                     
########################################################################################
            if (46 in image2 and 46 in image and 46 in image4):
                if (d2>d3 and d3>d1 ):
                    j()
                elif (d1>d3 and d3>d2):
                    m()
                    ...
                    l()                  
##########################################################################################
            if (66 in image2 and 46 in image and 46 in image4):
                if (d1>d3):
                    l()
                elif(d3>d1):
                    j()
            if (46 in image2 and 66 in image and 46 in image4):
                if (d2>d3):
                    l()
                elif(d3>d2):
                    m()               
            if (46 in image2 and 46 in image and 66 in image4):
                if (d1>d2):
                    m()
                elif(d2>d1):
                    j()
