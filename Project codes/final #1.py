...
def k ():
    ...
    if clientID!=-1:
        ...
        #HANDLES
        res,rightmotor1=vrep.simxGetObjectHandle(clientID,'K3_rightWheelMotor#2',vrep.simx_opmode_blocking)
        res,leftmotor1=vrep.simxGetObjectHandle(clientID,'K3_leftWheelMotor#2',vrep.simx_opmode_blocking)
     ...
     #   res,gpsY=vrep.simxGetObjectHandle(clientID,'K3_GPSY',vrep.simx_opmode_blocking)
      #  res,gpsZ=vrep.simxGetObjectHandle(clientID,'K3_GPSZ',vrep.simx_opmode_blocking)
        ...
        res,robot3=vrep.simxGetObjectHandle(clientID,'K3_robot',vrep.simx_opmode_blocking)
        ...
        res,robot=vrep.simxGetObjectHandle(clientID,'K3_robot#1',vrep.simx_opmode_blocking)
...
##        z=a[2]
     ...
     #####################################################################
       ...
       #################################################################################################################################
        ...
        while 46 in image4:#stop khepera at goal
            if (0 in image2 and 0 in image3 and 0 in image):
            ...
            if (66 in image2 and 0 in image3 and 0 in image):
                ...
                if (d1>d3):
                    ...
                    j()
            if (0 in image2 and 66 in image3 and 0 in image):
                ...
                if (d2>d3):
                    ...
                    m()
            if (0 in image2 and 0 in image3 and 66 in image):
...
##########################################################################33
            if (66 in image2 and 86 in image3 and 0 in image):
                ...
                if (d1>d3):
                    ...
                    j()
            if (86 in image2 and 66 in image3 and 0 in image):
                ...
                if (d2>d3):
                    ...
                    m()
            if (0 in image2 and 86 in image3 and 66 in image):
                ...
                if (d1>d2):
                    ...
                    j()         
            if (66 in image2 and 0 in image3 and 86 in image):
            ...
            if (86 in image2 and 0 in image3 and 66 in image):
...
def l ():
    ...
    if clientID!=-1:
        ...
        res,object3=vrep.simxGetObjectHandle(clientID,'Object3',vrep.simx_opmode_blocking)
        res,robot=vrep.simxGetObjectHandle(clientID,'K3_robot#1',vrep.simx_opmode_blocking)
        res,robot2=vrep.simxGetObjectHandle(clientID,'K3_robot',vrep.simx_opmode_blocking)    
