    ...
    if clientID!=-1:
     ...
     #   res,gpsY=vrep.simxGetObjectHandle(clientID,'K3_GPSY',vrep.simx_opmode_blocking)
      #  res,gpsZ=vrep.simxGetObjectHandle(clientID,'K3_GPSZ',vrep.simx_opmode_blocking)
        res,q1=vrep.simxGetObjectHandle(clientID,'K3_colorSensorLeft#0',vrep.simx_opmode_blocking)
        res,q3=vrep.simxGetObjectHandle(clientID,'K3_colorSensorLeft#2',vrep.simx_opmode_blocking)
        res,q2=vrep.simxGetObjectHandle(clientID,'K3_colorSensorLeft#1',vrep.simx_opmode_blocking)
